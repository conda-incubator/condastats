...
def test_date_range(get_overall):
    ...
    range_result = get_overall('pandas', start_month=TEST_START_MONTH, end_month=TEST_END_MONTH)
...
def test_monthly_aggregation(get_overall):
    ...
    result = get_overall('pandas', start_month=TEST_START_MONTH, end_month=TEST_END_MONTH, monthly=True)
